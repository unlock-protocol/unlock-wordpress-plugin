...
namespace Unlock_Protocol\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Unlock_Protocol\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( UNLOCK_PROTOCOL_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Unlock_Protocol\Inc\Helpers\autoloader' );
