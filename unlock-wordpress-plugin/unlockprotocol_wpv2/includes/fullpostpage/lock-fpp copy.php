...
function unlockprotocol_wpv2_validate_network_input($input) {
    $valid_networks = array('1', '137', 'mainnet', 'Ethereum Mainnet', 'Polygon Mainnet', 'Arbitrum Mainnet', 'GnosisChain Mainnet', 'Optimism Mainnet', 'BNBChain Mainnet', 'Testnetwork1 Testnet');
